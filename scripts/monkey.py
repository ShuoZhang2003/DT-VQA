...
from monkey_model.modeling_qwen import QWenLMHeadModel
...
def _get_args():
    ...
    parser.add_argument("--model_path", type=str, default="./model_weights/monkey")
...
def eval_worker(args, data, eval_id, output_queue):
    ...
    model = AutoModelForCausalLM.from_pretrained(checkpoint, device_map='cuda:0', **config_kwargs).eval()
    tokenizer = AutoTokenizer.from_pretrained(checkpoint, **config_kwargs)
